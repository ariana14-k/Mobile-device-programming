                ...
                <View style={[styles.box, isSuccess ? styles.successBox : styles.errorBox]}>
                    ...
                    <View style={styles.buttons}>
                        {showConfirm && onConfirm && (
                            <TouchableOpacity style={[styles.btn, isSuccess ? styles.successBtn : styles.errorBtn]} onPress={() => {
                                onConfirm();
                                onClose();
                            }}>
                        ...
                        <TouchableOpacity onPress={onClose} style={[styles.btn, {backgroundColor: "gray"}]}>
                            <Text style={styles.btnText}>{showConfirm ? "Confirm" : "OK"}</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
